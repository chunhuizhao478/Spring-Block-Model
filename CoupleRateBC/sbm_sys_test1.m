function [f2] = sbm_sys_test1(y,coeff1,coeff2,coeff3,coeff4,sigma_initial,f_o,a,b,t_step,alpha)
%unknown [theta,u,v]
global p_cur p_pre
f2 = [ coeff4 -  abs(y(3)+coeff3) * y(1) + ( alpha * sigma_initial * y(1) ) / ( b * (sigma_initial - p_cur * sigma_initial) ) * ( p_cur - p_pre) / t_step; 
       y(3);
